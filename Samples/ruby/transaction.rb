...
module PayFabric
  ...
  # see [API](https://github.com/PayFabric/APIs/tree/v2)
  ...
  module Transaction
    ...
    module Sandbox
      ...
      # [More Info](https://github.com/PayFabric/APIs/blob/v2/Sections/Transactions.md#create-a-transaction)
      # 
      # +options+ - trasaction hash [see](https://github.com/PayFabric/APIs/blob/v2/Sections/Objects.md#transaction)
      # @return Hash 
      #
      #  Example: 
      #    
      ...
      def create(device_id, password, options)
        url = "https://sandbox.payfabric.com/v2/rest/api/transaction/create"
        Share::create(url, device_id, password, options)
      end

      #  ## Update a Transaction
      #  [Info](https://github.com/PayFabric/APIs/blob/v2/Sections/Transactions.md#update-a-transaction)
      ...
      def update(device_id, password, options)
        url = "https://sandbox.payfabric.com/v2/rest/api/transaction/update"
        Share::create(url, device_id, password, options)
      end

      #  ## Process a Transaction by Transaction Key
      #  [Info](https://github.com/PayFabric/APIs/blob/v2/Sections/Transactions.md#process-a-transaction)
      ...
      #      }  
      #
      # @return [Transaction Response](https://github.com/PayFabric/APIs/blob/v2/Sections/Objects.md#transaction-response)
      #  
      def process(device_id, password, trx_key)
        url = "https://sandbox.payfabric.com/v2/rest/api/transaction/process/#{trx_key}"
        Share::process(url, device_id, password)
      end

      #  ## Process a Transaction by Transaction Object
      #  [Info](https://github.com/PayFabric/APIs/blob/v2/Sections/Transactions.md#create-and-process-a-transaction)
      ...
      # 
      #  +options+ - [Transaction Object](https://github.com/PayFabric/APIs/blob/v2/Sections/Objects.md#transaction)
      #
      #  Example:
      #    options = {
      #      "Customer" => "AARONFIT0001",
      ...
      #       }
      #   
      #  @return [Transaction Response Object](https://github.com/PayFabric/APIs/blob/v2/Sections/Objects.md#transaction-response)
      #
      #  
      def process_object(device_id, password, options)
        url = "https://sandbox.payfabric.com/v2/rest/api/transaction/process"
        Share::process_object(url, device_id, password, options)
      end

      #  ## Retrieve a Transaction
      #  [Info](https://github.com/PayFabric/APIs/blob/v2/Sections/Transactions.md#retrieve-a-transaction)
      #  
      #  +trx_key+ - transaction key
      #  
      #  Example:
      ...
      #     }
      #     
      #  @return [Transaction](https://github.com/PayFabric/APIs/blob/v2/Sections/Objects.md#transaction)  
      #
      def retrieve(device_id, password, trx_key)
        url = "https://sandbox.payfabric.com/v2/rest/api/transaction/#{trx_key}"
        Share::retrieve(url, device_id, password)   
      end

      #  ## Capture a Pre-Authorized Transaction
      #  [Info](https://github.com/PayFabric/APIs/blob/v2/Sections/Transactions.md#referenced-transactions-void-capture-ship-or-credit)
      #  
      #  +trx_key+ - transaction key
      #  
      #  Example 
      ...
      def capture(device_id, password, trx_key)
        url = "https://sandbox.payfabric.com/v2/rest/api/reference/#{trx_key}?trxtype=Ship"
      ...
      def cancel(device_id, password, trx_key)
        url = "https://sandbox.payfabric.com/v2/rest/api/reference/#{trx_key}?trxtype=Void"
        Share::cancel(url, device_id, password)
      end

      #  ## Refund a Customer
      #  [Info](https://github.com/PayFabric/APIs/blob/v2/Sections/Transactions.md#refund-a-customer)
      #  
      #  +options+ - Hash object  
      #
      #  Example 
    ...
    module Live
      ...
      # see Sandbox::create
      def create(device_id, password, options)
        url = "https://www.payfabric.com/v2/rest/api/transaction/create"
        Share::create(url, device_id, password, options)
      end
      # see Sandbox::update
      def update(device_id, password, options)
        url = "https://www.payfabric.com/v2/rest/api/transaction/update"
        Share::create(url, device_id, password, options)
      end
      # see Sandbox::process
      def process(device_id, password, trx_key)
        url = "https://www.payfabric.com/v2/rest/api/transaction/process/#{trx_key}"
        Share::process(url, device_id, password)
      end
      # see Sandbox::process_object
      def process_object(device_id, password, options)
        url = "https://www.payfabric.com/v2/rest/api/transaction/process"
        Share::process_object(url, device_id, password, options)
      end
      # see Sandbox::retrieve
      def retrieve(device_id, password, trx_key)
        url = "https://www.payfabric.com/v2/rest/api/transaction/#{trx_key}"
        Share::retrieve(url, device_id, password)   
      end
      # see Sandbox::capture
      def capture(device_id, password, trx_key)
        url = "https://www.payfabric.com/v2/rest/api/reference/#{trx_key}?trxtype=Ship"
        Share::capture(url, device_id, password)
      end
      # see Sandbox::cancel
      def cancel(device_id, password, trx_key)
        url = "https://www.payfabric.com/v2/rest/api/reference/#{trx_key}?trxtype=Void"
        Share::cancel(url, device_id, password)
      end
      # see Sandbox::refund
      def refund(device_id, password, options) 
