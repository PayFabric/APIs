...
module PayFabric
  ...
  module Wallet
    ...
    module Sandbox
      ...
      #  [Info](https://github.com/PayFabric/APIs/blob/v2/Sections/Wallets.md#create-a-credit-card)
      #
      #  +options+ - [Card hash](https://github.com/PayFabric/APIs/blob/v2/Sections/Objects.md#card)
      #  
      #  Example 
      #    
      #    options = {
      ...
      def add(device_id, password, options)
        url = "https://sandbox.payfabric.com/v2/rest/api/wallet/create"
        Share::add(url, device_id, password, options)
      end

      #  ## Update an Existing Card
      #  [Info](https://github.com/PayFabric/blob/v2/Sections/Wallets.md#update-a-credit-card--echeck)
      #  
      #  +options+ - [Card hash](https://github.com/PayFabric/APIs/blob/v2/Sections/Objects.md#card)
      #  
      #  Example
      ...
      def update(device_id, password, options)
        url = "https://sandbox.payfabric.com/v2/rest/api/wallet/update"
        Share::update(url, device_id, password, options)
      end

      #  ## Remove a Card  
      #  [Info](https://github.com/PayFabric/APIs/blob/v2/Sections/Wallets.md#remove-credit-card--echeck)
      #  
      #  +id+ - Card ID 
      #  
      #  Example 
      ...
      def remove(device_id, password, id)
        url = "https://sandbox.payfabric.com/v2/rest/api/wallet/delete/#{id}"
        Share::remove(url, device_id, password)
      end

      #  ## Retrieve Cards By Customer
      #  [Info](https://github.com/PayFabric/APIs/blob/v2/Sections/Wallets.md#retrieve-credit-cards--echecks)
      #  
      ...
      #    hash # => [{"ID" => "123" }, { "ID" => "124" }]
      #
      #  @reutrn [Array of Cards](https://github.com/PayFabric/APIs/blob/v2/Sections/Objects.md#card)
      # 
      def retrieve(device_id, password, customer)
        url = "https://sandbox.payfabric.com/v2/rest/api/wallet/get/#{customer}"
    ...
    module Live
      extend self
      def add(device_id, password, options)
        url = "https://www.payfabric.com/v2/rest/api/wallet/create"
        Share::add(url, device_id, password, options)
      end

      def update(device_id, password, options)
        url = "https://www.payfabric.com/v2/rest/api/wallet/update"
        Share::update(url, device_id, password, options)
      end

      def remove(device_id, password, id)
        url = "https://www.payfabric.com/v2/rest/api/wallet/delete/#{id}"
        Share::remove(url, device_id, password)
      end

      def retrieve(device_id, password, customer)
        url = "https://www.payfabric.com/v2/rest/api/wallet/get/#{customer}"
        Share::retrieve(url, device_id, password)
      end
    end
  end
