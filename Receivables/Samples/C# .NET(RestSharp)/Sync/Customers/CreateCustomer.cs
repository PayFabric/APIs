...
public void CreateCustomer(string json, string URL, Token token, ref Response responses)
{
	// Sample request and response
	// ------------------------------------------------------
	// Go to https://github.com/PayFabric/APIs/blob/master/Receivables/Sections/APIs/Sync/Customers.md#create-or-update-a-customer for more details about request and response.
	...
	var client = new RestClient(URL + "sync/API/customers");
