...
public void GetIntegrations(string URL, Token token, ref IntegrationPagingResponse integrations)
{
	...
	// ------------------------------------------------------
	// Go to https://github.com/PayFabric/APIs/blob/master/Receivables/Sections/APIs/Sync/Integrations.md#retrieve-integration-documents for more details about request and response.
	// Go to https://github.com/PayFabric/APIs/blob/master/Receivables/Sections/Objects/Integration.md#IntegrationPagingResponse for more details about the object.
	// ------------------------------------------------------
