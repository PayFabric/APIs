/// <summary>
/// API Request to void the payment on PayFabric Receivables
/// </summary>
/// <param name="URL">URL of the PayFabric Receivables site</param>
/// <param name="paymentId">PaymentId to be voided</param>
/// <param name="token">PayFabric Receivables token object</param>
/// <param name="responses">Returned response object</param>
public void CreatePayment(string URL, string paymentId, Token token, ref Response responses)
{
