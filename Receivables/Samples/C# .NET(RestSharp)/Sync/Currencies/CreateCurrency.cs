...
public void CreateCurrency(string json, string URL, Token token, ref Response responses)
{
	...
	// ------------------------------------------------------
	// Go to https://github.com/PayFabric/APIs/blob/master/Receivables/Sections/APIs/Sync/Currencies.md#create-a-currency for more details about request and response.
	// Go to https://github.com/PayFabric/APIs/blob/master/Receivables/Sections/Objects/Currency.md#CurrencyPost for more details about the object.
	// ------------------------------------------------------
