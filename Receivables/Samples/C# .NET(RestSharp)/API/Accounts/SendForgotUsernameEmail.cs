/// <summary>
/// API Request to send the forgot username email on PayFabric Receivables
/// </summary>
...
public void SendForgotUsernameEmail(string json, string URL, Token token, ref Response responses)
{
