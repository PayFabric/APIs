...
public void SendResetPasswordEmail(string json, string URL, Token token, ref Response responses)
{
	...
	// ------------------------------------------------------
	// Go to https://github.com/PayFabric/APIs/blob/master/Receivables/Sections/APIs/API/Accounts.md#send-reset-password-email for more details about request and response.
	// Go to https://github.com/PayFabric/APIs/blob/master/Receivables/Sections/Objects/ResetPasswordEmail.md for more details about the object.
	// ------------------------------------------------------
