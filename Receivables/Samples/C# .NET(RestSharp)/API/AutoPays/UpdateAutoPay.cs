/// <summary>
/// API Request to update an autopay to a customer on PayFabric Receivables
/// </summary>
...
public void SaveAutoPay(string json, string URL, Token token, ref Response responses)
{
	...
	// ------------------------------------------------------
	// Go to https://github.com/PayFabric/APIs/blob/master/Receivables/Sections/APIs/API/AutoPays.md#update-an-autopay for more details about request and response.
