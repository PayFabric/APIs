...
## Address
Address objects represent the shipping or billing address of a customer. Gift card does not have billing address. This object may be included as a child attribute of other JSON objects (such as [Card](#card)).
...
## CardHolder
The cardholder object represents the owner of a credit card or eCheck. This object is always included as a child object of the Card object. Gift card does not have card holder.
...
## Card
The Card object represents a Credit Card, Gift Card or eCheck of a customer.
...
| Tender*          | Options | Tender type. Valid options are ``CreditCard``,``GiftCard``, ``ECheck``, `ApplePay` and `GooglePay`. |nvarchar(64)|
