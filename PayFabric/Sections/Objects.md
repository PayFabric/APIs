...
|EntryClass|string|This specifies the SEC Code of the ACH transaction processed. Acceptable values are: TEL, PPD, CCD, and WEB. This field is not required. It defaults to the DefaultEntryClass setting on the PayFabric Gateway Profile.|
