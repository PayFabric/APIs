...
module PayFabric
  ...
  module ShippingAdress
    ...
    module Sandbox
      ...
      #  [Info](https://github.com/PayFabric/APIs/blob/master/PayFabric/Sections/Addresses.md#retrieve-shipping-addresses)
      #  
      ...
      #    
      #  @return [Array with Adresses](https://github.com/PayFabric/APIs/blob/master/PayFabric/Sections/Objects.md#address)
      #
      def retrieve_by_customer(device_id, password, customer)
        url = "https://sandbox.payfabric.com/payment/api/addresses/#{customer}"
        Share::retrieve_by_customer(url, device_id, password)
      end

      #  ## Retrieve Shipping Address By Id
      #  [Info](https://github.com/PayFabric/APIs/blob/master/PayFabric/Sections/Addresses.md#retrieve-a-shipping-address)
      #  
      #  +id+ - customer id
      #  
      #  Example
      ...
      #    hash # => {"ID" => "123"}
      #
      #  @return [Adress Hash](https://github.com/PayFabric/APIs/blob/master/PayFabric/Sections/Objects.md#address)
      #
      def retrieve(device_id, password, id)
        url = "https://sandbox.payfabric.com/payment/api/address/#{id}"
    ...
    module Live
      ...
      def retrieve_by_customer(device_id, password, customer)
        url = "https://www.payfabric.com/payment/api/addresses/#{customer}"
        Share::retrieve_by_customer(url, device_id, password)
      end

      def retrieve(device_id, password, id)
        url = "https://www.payfabric.com/payment/api/address/#{id}"
        Share::retrieve(url, device_id, password)
      end
    end
  end
