...
* [Create a new transaction](https://github.com/PayFabric/APIs/wiki#createtrx)
* [Update a transaction](https://github.com/PayFabric/APIs/wiki#updatetrx)
* [Process a transaction by transaction key](https://github.com/PayFabric/APIs/wiki#proctrx1)
* [Process a transaction by transaction object](https://github.com/PayFabric/APIs/wiki#proctrx2)
* [Retrieve a transaction](https://github.com/PayFabric/APIs/wiki#gettrx)
* [Add a Card into Wallet](https://github.com/PayFabric/APIs/wiki#addcard)
* [Update an Existing Card](https://github.com/PayFabric/APIs/wiki#updatecard)
* [Remove a Card](https://github.com/PayFabric/APIs/wiki#deletecard)
* [Retrieve Cards by Customer](https://github.com/PayFabric/APIs/wiki#allcards)

# Misc APIs
* [Retrieve All Gateway Account Profiles](https://github.com/PayFabric/APIs/wiki#allgateways)
* [Retrieve a Gateway Account Profile By Id](https://github.com/PayFabric/APIs/wiki#gateway)
* [Retrieve Shipping addresses by Customer](https://github.com/PayFabric/APIs/wiki#allshiptos)
* [Retrieve Shipping address by Id](https://github.com/PayFabric/APIs/wiki#shipto)
