...
> Before drilling down to each API, you may want to get familiar with all the [JSON Objects](https://www.payfabric.com) we are heavily using as payload of request and response. 
