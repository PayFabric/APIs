...
* `GET /api/addresses/John+Doe+Ltd` or `/api/addressesByCustomer?customer=John+Doe+Ltd` will return all shipping addresses for the specified customer, the latter support special characters.
