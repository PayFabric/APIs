...
* `GET /rest/api/wallet/get/JOHNDOE0001?tender=CreditCard` or GET `/rest/api/wallet/getByCustomer?customer=JOHNDOE0001&tender=CreditCard` will return the credit cards or eChecks for a customer depending on the tender type (_CreditCard_, _ECheck_), the latter support special characters.
